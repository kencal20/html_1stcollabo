...
document
  ...
  .addEventListener("mouseover", inputshadow0a);
document
  .getElementsByClassName("input")[0]
  .addEventListener("mouseout", inputshadow0b);
document
  .getElementsByClassName("input")[1]
  .addEventListener("mouseover", inputshadow1a);
document
  .getElementsByClassName("input")[1]
  .addEventListener("mouseout", inputshadow1b);
document
  .getElementsByClassName("input")[2]
  .addEventListener("mouseover", inputshadow2a);
document
  .getElementsByClassName("input")[2]
  .addEventListener("mouseout", inputshadow2b);
document
  .getElementsByClassName("input")[3]
  .addEventListener("mouseover", inputshadow3a);
document
  .getElementsByClassName("input")[3]
  .addEventListener("mouseout", inputshadow3b);
document
  .getElementsByClassName("input")[4]
  .addEventListener("mouseover", inputshadow4a);
document
  .getElementsByClassName("input")[4]
  .addEventListener("mouseout", inputshadow4b);
document
  .getElementsByClassName("input")[5]
  .addEventListener("mouseover", inputshadow5a);
document
  .getElementsByClassName("input")[5]
  .addEventListener("mouseout", inputshadow5b);
document
  .getElementsByClassName("radio")[0]
  .addEventListener("mouseover", radioshadow0a);
document
  .getElementsByClassName("radio")[0]
  .addEventListener("mouseout", radioshadow0b);
document
  .getElementsByClassName("radio")[1]
  .addEventListener("mouseover", radioshadow1a);
document
  .getElementsByClassName("radio")[1]
  .addEventListener("mouseout", radioshadow1b);
document
  .getElementsByClassName("radio")[2]
  .addEventListener("mouseover", radioshadow2a);
document
  .getElementsByClassName("radio")[2]
  .addEventListener("mouseout", radioshadow2b);
